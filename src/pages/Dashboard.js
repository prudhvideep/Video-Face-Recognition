    ...
    <>
      <div className="min-h-screen">
        ...
        <div className="w-full h-1/2">
          <div className="flex flex-col items-center justify-center md:flex-row md:space-x-2 md:justify-around md:items-start">
            <div className="flex flex-col space-y-2 w-9/10 md:w-7/10 mt-4">
              {showMessage && (
                <div className="mt-2 p-2 w-9/10 ml-auto mr-auto flex items-center justify-center space-x-4 bg-indigo-100 text-indigo-700 border-2 border-indigo-300/50 hover:bg-indigo-150 rounded-2xl hover:cursor-pointer">
              ...
              <div className="mt-2 ml-auto mr-auto w-9/10 rounded-lm">
                <UploadMedia
                  user={user}
            ...
            <div className="w-9/10 md:w-7/10 mt-4">
              <div className="flex flex-col mt-2 h-9/10 w-9/10 ml-auto mr-auto bg-white p-6 py-auto rounded-2xl shadow-2xl border-2 hover:border-indigo-300 overflow-auto">
                <div className="flex flex-row justify-start font-medium text-2xl space-x-2 items-center ">
                  <h2>Results</h2>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <div className="mt-4">
                  <div className="bg-gray-100 flex font-semibold">
                    <div className="w-1/3 p-2 text-center">Request</div>
                    <div className="w-1/3 p-2 text-center">Result</div>
                    <div className="w-1/3 p-2 text-center">Action</div>
                  </div>
                  <div className="h-110 overflow-y-auto">
                    {results && results.map((item, index) => (
                      <div key={index} className="flex items-center border-b py-2">
                        ...
                        <div className="w-1/3 text-center text-slate-500 font-semibold">
                          {item.faceresult}
                        </div>
                        <div className="w-1/3 flex justify-center">
                          <svg
                            ...
                            className="size-6 text-gray-400 hover:text-blue-900 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 cursor-pointer"
                          >
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
